...
public class FunctionTab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    if (success) {
                        switch (index) {
                            ...
                            case 1:
                                ...
                                Log.w("suck","1");
                                Log.w("suck",String.valueOf(sum_l/i));
                                break;
                            ...
                            case 2:
                                ...
                                th_lf.setText(String.valueOf(sum_lf/co));
                                th_lm.setText(String.valueOf(sum_lm/co));
                                th_lb.setText(String.valueOf(sum_lb/co));
                                th_rf.setText(String.valueOf(sum_rf/co));
                                th_rm.setText(String.valueOf(sum_rm/co));
                                th_rb.setText(String.valueOf(sum_rb/co));
                            ...
                            //지지분포
                              case 3:
                                ...
                                for (i2 = 0; i2 < arrDateList.length(); i2++) {
                                    ...
                                    if (count_s == 0 && shun == "4321") {
                                        numl += 1;
                                    } else if (count_s == 0 && shun == "4213") {
                                        numl1 += 1;//(바깥)
                                    } else if (count_s == 0 && shun == "4312") {
                                        numl2 += 1;//(안쪽)
                                    } else if (count_s == 1 && shun == "4321") {
                                        numr += 1;
                                    } else if (count_s == 1 && shun == "4213") {
                                        numr1 += 1;//(바깥)
                                    } else {
                                        numr2 += 1;//(안쪽)
                                    }
        ...
        TabHost.TabSpec tab1 = tabHost.newTabSpec("1").setIndicator("보폭");
        tab1.setContent(R.id.tab1);
        tabHost.addTab(tab1);

        TabHost.TabSpec tab2 = tabHost.newTabSpec("2").setIndicator("균형");
