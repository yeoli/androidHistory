...
public class FiveTabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /****레이더차트 관련 객체 초기화**/
        radari = findViewById(R.id.radari);
        RadarDataSet dataSet1 = new RadarDataSet(dataValues1(), "누적된 사항");
        RadarDataSet dataSet2 = new RadarDataSet(dataValues2(), "현재");
        dataSet1.setColor(Color.BLUE); //각데이터의 색을 지정
        dataSet2.setColor(Color.GREEN);
        RadarData data = new RadarData();
        data.addDataSet(dataSet1);
        data.addDataSet(dataSet2);
        XAxis xAxis = radari.getXAxis();
        ...
        tab5.setIndicator(null, ResourcesCompat.getDrawable(getResources(), R.drawable.graph, null));
